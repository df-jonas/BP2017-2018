...
<style type="text/css">
    ...
    #templateHeader{
        /*@editable*/background-color:#4d6a50;
                                                    ...
                                                    <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                                ...
                                                                <img alt="" src="https://gallery.mailchimp.com/f29e41bdbbcefab7c8478106b/images/b1cb7148-ffbb-455d-9c18-efcddea02a07.png" style="max-width:64px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" width="64" align="middle">
                                    ...
                                    <td valign="top" class="bodyContainer"><table class="mcnTextBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    ...
                                                    <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                ...
                                                                <h1><span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif">Welkom bij UniHelp</span></h1>
                                                    ...
                                                    <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                                ...
                                                                <img alt="" src="{{ $header }}" style="max-width:5184px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" width="564" align="middle">
                                            ...
                                            <tr>
                                                <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                                                    <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 0px;background-color: #4D6A50;" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;" valign="middle" align="center">
                                                                <a class="mcnButton " title="Ga aan de slag" href="{{ $url }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Ga aan de slag</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="mcnCaptionBottomContent" width="282" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            <td class="mcnCaptionBottomImageContent" style="padding:0 9px 9px 9px;" valign="top" align="center">
                                                                ...
                                                                <!--<img alt="" src="https://gallery.mailchimp.com/f29e41bdbbcefab7c8478106b/images/25d68877-c24f-49ed-a6d7-779a12737dbe.png" style="max-width:1144px;" class="mcnImage" width="264"> -->

                                                                <img alt="" src="{{ $image1 }}" style="max-width:1144px;" class="mcnImage" width="264">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="mcnTextContent" style="padding:0 9px 0 9px;" width="282" valign="top">
                                                                <div style="text-align: center;">Blijf steeds op de hoogte via interesse groepen.</div>
                                                    ...
                                                    <table class="mcnCaptionBottomContent" width="282" cellspacing="0" cellpadding="0" border="0" align="right">
                                                        <tbody><tr>
                                                            <td class="mcnCaptionBottomImageContent" style="padding:0 9px 9px 9px;" valign="top" align="center">
                                                                ...
                                                                <img alt="" src="{{ $image2 }}" style="max-width:1144px;" class="mcnImage" width="264">
                                                        ...
                                                        <tr>
                                                            <td class="mcnTextContent" style="padding:0 9px 0 9px;" width="282" valign="top">
                                                                <div style="text-align: center;">Deel interessante bestanden met medestudenten.</div>
                                                    ...
                                                    <table class="mcnCaptionBottomContent" width="282" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            <td class="mcnCaptionBottomImageContent" style="padding:0 9px 9px 9px;" valign="top" align="center">
                                                                ...
                                                                <img alt="" src="{{ $image3 }}" style="max-width:1144px;" class="mcnImage" width="264">
                                                        ...
                                                        <tr>
                                                            <td class="mcnTextContent" style="padding:0 9px 0 9px;" width="282" valign="top">
                                                                <div style="text-align: center;">Krijg hulp via het tutoring gedeelte of geef zelf tutoring.</div>
                                                    ...
                                                    <table class="mcnCaptionBottomContent" width="282" cellspacing="0" cellpadding="0" border="0" align="right">
                                                        <tbody><tr>
                                                            <td class="mcnCaptionBottomImageContent" style="padding:0 9px 9px 9px;" valign="top" align="center">
                                                                ...
                                                                <img alt="" src="{{ $image4 }}" style="max-width:1144px;" class="mcnImage" width="264">
                                                        ...
                                                        <tr>
                                                            <td class="mcnTextContent" style="padding:0 9px 0 9px;" width="282" valign="top">
                                                                <div style="text-align: center;">Beoordeel medestudenten via de peer assessment tool.</div>
                                    ...
                                    <td valign="top" class="footerContainer"><table class="mcnFollowBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                            ...
                                                                                                            <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                                                                <table width="" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                                                    <tbody><tr>
                                                                                                                        ...
                                                                                                                        <td class="mcnFollowIconContent" width="24" valign="middle" align="center">
                                                                                                                            <a href="https://www.unihelp.be" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-link-48.png" style="display:block;" class="" width="24" height="24"></a>
                                                                                                                        </td>
                                            ...
                                            <tr>
                                                <td class="mcnDividerBlockInner" style="min-width:100%; padding:18px;">
                                                    <table class="mcnDividerContent" style="min-width: 100%;border-top: 2px solid #FFFFFF;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody><tr>
                                                            <td>
                                                                <span></span>
                                                            </td>
                                                    ...
                                                    <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                ...
                                                                <em>Copyright © 2018 - UniHelp -  Alle rechten voorbehouen.</em><br>
                                                                <br>

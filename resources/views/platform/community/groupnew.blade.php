...
@section('content')
    ...
    <!-- end profile message -->
        <form method="POST" action="{{ route('admin-groups-new') }}">
            {{ csrf_field() }}
                    ...
                    <div class="padding">
                        ...
                        <div class="form-group col-xs-12 no-padding">
                            <div class="textdiv">
                                ...
                                <textarea id="desc" name="desc" type="text" class="form-control col-xs-12" rows="2"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-xs-12 no-padding">
                            <div class="textdiv">
                                ...
                                <input id="url" name="url" type="text" class="form-control col-xs-12">
                            </div>
                        </div>

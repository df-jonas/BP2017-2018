            ...
            <section class="content community detail">
                <section id="groupcontainer" class="item groups">
                    <section class="group-detail detail clearfix">
                        <header><a class="header-title">{{ $post->group->category->name }}
                                > {{ $post->group->name }}</a></header>
                        <article class="detail group col-xs-12">
                            ...
                            <section id="comment-box" class="row flex padding">
                                ...
                                <form id="comment-form" class="col-lg-11 col-sm-10 col-xs-12" method="POST"
                                    ...
                                    <section class="txt col-lg-11 col-sm-10 col-xs-10">
                                        <input type="text" name="comment" id="commentfield" class="col-xs-11"
                                               placeholder="reactie toevoegen" tabindex="1">
                                    </section>
                                    <section class="icon col-lg-1 col-sm-2 col-xs-2 no-padding">
                                        <button type="submit" class="col-xs-12"><i class="fa fa-paper-plane"></i>
                                        </button>
                                    </section>
                                </form>
                            </section>

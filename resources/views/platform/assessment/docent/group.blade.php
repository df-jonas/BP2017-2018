                ...
                <div class="item padding clearfix" style="padding:0 15px 0 15px">
                    ...
                    <div class="row flex padding">
                        ...
                        <table class="assessment group">
                            ...
                            <tr>
                                <td class="left"><a href="#">Stalpaert, Arno</a><img src="{{ asset('img/avatars/' . Auth::user()->image )}}" class="group-img round-img hide-tablet" alt="User profile image"></td>
                                <td>5</td>
                                <td><a href="#">Bekijk uitgedeelde scores <i class="fas fa-arrow-right"></i></a></td>
                                <!--<td><a href="#">Bekijk ontvangen scores <i class="fas fa-arrow-right"></i></a></td>-->
                            </tr>
                            <tr>
                                <td class="left"><a href="#">De Frère, Jonas</a> <img src="{{ asset('img/avatars/' . Auth::user()->image )}}" class="group-img round-img hide-tablet" alt="User profile image"></td>
                                <td>4</td>
                                <td><a href="#">Bekijk uitgedeelde scores <i class="fas fa-arrow-right"></i></a></td>
                                <!--<td><a href="#">Bekijk ontvangen scores <i class="fas fa-arrow-right"></i></a></td>-->
                            </tr>
                            <tr>
                                <td class="left"><a href="#">Goeman, Sam </a><img src="{{ asset('img/avatars/' . Auth::user()->image )}}" class="group-img round-img hide-tablet" alt="User profile image"></td>
                                <td>2</td>
                                <td><a href="#">Bekijk uitgedeelde scores <i class="fas fa-arrow-right"></i></a></td>
                                <!--<td><a href="#">Bekijk ontvangen scores <i class="fas fa-arrow-right"></i></a></td>-->
                            </tr>
                            <tr>
                                <td class="left"><a href="#">Janssens, Brent </a><img src="{{ asset('img/avatars/' . Auth::user()->image )}}" class="group-img round-img hide-tablet" alt="User profile image"></td>
                                <td>4</td>
                                <td><a href="#">Bekijk uitgedeelde scores <i class="fas fa-arrow-right"></i></a></td>
                                <!--<td><a href="#">Bekijk ontvangen scores <i class="fas fa-arrow-right"></i></a></td>-->
                            </tr>

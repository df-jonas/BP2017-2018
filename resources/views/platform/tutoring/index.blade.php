    ...
    <div class="table tutoring flex">
        ...
        <div id="people-list-detail" class="content detail clearfix">
            ...
            <article class="item col-xs-12">
                <div class="padding clearfix userpanel" style="visibility: hidden">
                    <div class="row">
                        <div class="col-lg-6 left col-md-4 col-sm-6 col-xs-12">
                            <div class="table">
                                <div style="display: table-cell; width: 42px">
                                    <img id="image" src="" class="group-img round-img round-img"/>
                                </div>
                                <div style="display: table-cell; padding-left: 16px; vertical-align: middle">
                                    <h6 id="name" style="margin: 0"></h6>
                                    <h6 id="course" style="margin: 5px 0"></h6>
                                </div>
                            </div>
                        </div>

<nav class="subheader">
    <div class="container">
        <ul>
            ...
            <li><a href="#"><span><i class="fa fa-clipboard" aria-hidden="true"></i></span>Peer Asessment</a></li>
            <li class="{{ ActiveHelper::getState(route('tutoring-index', [], false)) }}"><a href="{{ route("tutoring-index") }}"><span><i class="fa fa-life-ring" aria-hidden="true"></i></span>Tutoring<span style="margin-top: -20px; font-size: 10px" class="badge">3</span></a></li>
        </ul>
    </div>
</nav>
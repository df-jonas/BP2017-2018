            ...
            <div class="dropdown col-lg-10 col-sm-10 col-xs-12 clearfix">
                <div class="account">
                    <div class="account-user-notifications col-lg-2">
                        <i id="notDropdown" class="fa fa-bell dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="color:white;"></i><span>{{count(auth()->user()->notifications())}}</span>

                        <ul id="notifications-dropdown" class="dropdown-menu col-xs-12" aria-labelledby="notDropdown" style="z-index: 999999">
                            <li>
                                <a href="#"><i class="fa fa-download"></i> Notificatie 1
                                </a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-upload"></i> Notificatie 2 </a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-download"></i> Notificatie 3
                                </a>
                            </li>
                            <a class="dropdown-user-info padding" href="{{ route('profile-notifications') }}">
                    ...
                    <div class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="margin-left: 0.5em;">
                    ...
                    <ul id="account-dropdown" class="dropdown-menu col-xs-12" aria-labelledby="dropdownMenu1" style="z-index: 999999">
                        <a class="dropdown-user-info padding" href="{{ route('profile-index') }}">
                            <div class="row flex no-margin">
                                <div class="col-lg-3">

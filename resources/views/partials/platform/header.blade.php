        ...
        <div class="row">
            ...
            <div class="dropdown col-lg-10 col-sm-10 col-xs-12 clearfix">
                <div class="account">
                    ...
                    <ul id="account-dropdown" class="dropdown-menu col-xs-12" aria-labelledby="dropdownMenu1"
                        style="z-index: 999999">

                        <li><a href="{{ route('profile-index') }}"><i class="fa fa-dashboard"></i> Mijn profiel </a>
                        </li>
